        ...
        <div className="flex flex-col p-4 text-black gap-8 items-center max-w-screen-lg mx-auto">
          ...
          <div className="flex flex-col md:flex-row w-full justify-between gap-8">
            ...
            <div className="relative w-full md:w-[48%]">
              ...
              />
              <span
                className="absolute right-[8px] top-[5px] text-2xl cursor-pointer text-white"
          ...
          {!isloading ? (
            <>
              {passwordArray.length !== 0 ? (
                <>
                  <h2 className="font-bold text-2xl py-4 text-slate-100">
                    Your Passwords...
                  </h2>
                    ...
                    <table className="table-auto w-full rounded-md overflow-hidden ">
                      <thead className="bg-transparent border-2 rounded-3xl text-white">
                        <tr className="border-slate-100">
                          ...
                          <th className="py-2 border-l-2 border-slate-100">
                            Username/Id
                          </th>
                          <th className="py-2 border-l-2 border-slate-100">
                            Password
                ...
                <div className="font-bold text-2xl py-4 text-slate-100">
                  No Saved passwords yet...{" "}
                </div>
              )}
            </>
          ) : (
            <Loader2 className="w-10 h-10 text-white animate-spin mx-auto mt-10" />
          )}
        </div>
      </div>
    </>
